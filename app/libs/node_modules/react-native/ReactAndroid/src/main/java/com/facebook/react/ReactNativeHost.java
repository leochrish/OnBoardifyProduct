...
public abstract class ReactNativeHost {
   ...
   * {@link getBundleAssetName}. e.g. "file://sdcard/myapp_cache/index.android_1.bundle"
   */
   ...
   * try to load the JS bundle from the packager server. e.g. "index.android_1.bundle"
   */
  protected @Nullable String getBundleAssetName() {
    return "index.android_1.bundle";
  }
